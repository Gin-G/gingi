...
A living description of how Nick writes. Refine this over time as new patterns are noticed in samples and counter-examples. When a counter-example reveals a recurring failure mode, add the corrective pattern here.
...
When a counter-example shows a pattern Claude got wrong more than once, add the corrective rule here. When a sample reveals a habit not yet captured, add it. Keep the language concrete — "long sentences with stacked clauses" beats "sophisticated prose."
