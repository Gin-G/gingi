---
context: Performance review manager comment for direct report Varsha — Observability & Access Control goal (Grafana/Loki/Mimir multi-tenancy, ArgoCD RBAC Operator, Traefik migration)
